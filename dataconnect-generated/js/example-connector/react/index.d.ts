import { AddNewMovieListData, AddNewMovieListVariables, GetPublicMovieListsData, AddMovieToMovieListData, AddMovieToMovieListVariables, GetMoviesInMovieListData, GetMoviesInMovieListVariables } from '../';
...
export function useAddNewMovieList(options?: useDataConnectMutationOptions<AddNewMovieListData, FirebaseError, AddNewMovieListVariables>): UseDataConnectMutationResult<AddNewMovieListData, AddNewMovieListVariables>;
export function useAddNewMovieList(dc: DataConnect, options?: useDataConnectMutationOptions<AddNewMovieListData, FirebaseError, AddNewMovieListVariables>): UseDataConnectMutationResult<AddNewMovieListData, AddNewMovieListVariables>;
