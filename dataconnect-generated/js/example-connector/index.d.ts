...
export interface MovieListMovie_Key {
  movieListId: UUIDString;
  movieId: UUIDString;
  __typename?: 'MovieListMovie_Key';
}
...
export function addNewMovieList(vars: AddNewMovieListVariables): MutationPromise<AddNewMovieListData, AddNewMovieListVariables>;
export function addNewMovieList(dc: DataConnect, vars: AddNewMovieListVariables): MutationPromise<AddNewMovieListData, AddNewMovieListVariables>;
